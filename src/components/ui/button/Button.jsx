const Button = ({ children, size = "md", variant = "primary", startIcon, endIcon, onClick, className = "", disabled = false, }) => {
    ...
    const variantClasses = {
      ...
      outlineRed:
        "bg-white text-red-700 ring-1 ring-inset ring-red-300 hover:bg-red-50 dark:bg-gray-800 dark:text-white  dark:ring-red-500 dark:hover:bg-white/[0.03] dark:hover:text-red-300",
    };

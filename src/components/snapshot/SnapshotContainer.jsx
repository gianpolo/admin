...
export default function SnapshotContainer({ snapshotList, activeSnapshotId, handleAddSnapshot }) {
  ...
  const emptyContent = <EmptySnapshotWidget onAddSnapshot={handleAddSnapshot} />;
